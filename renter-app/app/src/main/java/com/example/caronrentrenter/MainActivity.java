...
//package com.example.pdfinvoice;
...
public class MainActivity extends AppCompatActivity {
    ...
    String userName, userMobile, carName, startDate, endDate, totalAmount, renterMobile, pickUpPointAddress, driver, deposit, rpd, start_date, end_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersRef.orderByChild("mobile").equalTo(object.getUserMobile()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                userName = name;
                userMobile = object.getUserMobile();
                carName = object.getCarModelName();
                startDate = object.getStartDate();
                endDate = object.getEndDate();
                totalAmount = object.getTotalAmount();
                renterMobile = object.getRenterMobile();
                pickUpPointAddress = object.getPickupPoint();
                driver = object.getDriver();
                deposit = "10000";
                rpd = object.getRentPerDay();
...
//                end_date=object.getEndDate();
        ...
        btn.setOnClickListener(view -> {
            if (checkPermission()) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                    ...
                    randomNum = (long) (rand.nextDouble() * 9_000_000_000L) + 1_000_000_000L;
    ...
    private void createPdfWithStorageFramework() {
        String pdfFileName = "Radhe_Cars.pdf";
    ...
    private void createPdf(Uri uri) {
        try {
            ...
            if (outputStream != null) {
                ...
                table1.addCell(new Cell().add(new Paragraph("#" + randomNum)).setBorder(Border.NO_BORDER));


//                //Table1------03
//                //  table1.addCell(new Cell().add(new Paragraph("")));
//                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
//                table1.addCell(new Cell().add(new Paragraph("Invoice Date:")).setBorder(Border.NO_BORDER));  //Sys date
//                table1.addCell(new Cell().add(new Paragraph("10-03-23")).setBorder(Border.NO_BORDER));
                ...
                table1.addCell(new Cell().add(new Paragraph(currentDate)).setBorder(Border.NO_BORDER));
                ...
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph("Starting journey Date : ")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph(startDate)).setBorder(Border.NO_BORDER));


                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph("Ending journey Date : ")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph(endDate)).setBorder(Border.NO_BORDER));
                ...
                //Table1------07
                table1.addCell(new Cell().add(new Paragraph(userName)).setBorder(Border.NO_BORDER));   //name
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph("Payment Method :").setBold()).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));

                //Table1------08
                table1.addCell(new Cell().add(new Paragraph(pickUpPointAddress)).setBorder(Border.NO_BORDER));  //pick-up point
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table1.addCell(new Cell(1, 2).add(new Paragraph("RozerPay : payments@sccarrent.com")).setBorder(Border.NO_BORDER));
                //table1.addCell(new Cell().add(new Paragraph("")));

                //Table1------09
                table1.addCell(new Cell().add(new Paragraph("SURAT")).setBorder(Border.NO_BORDER));  //static Surat
                table1.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                ...
                table2.addCell(new Cell().add(new Paragraph().setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));
                table2.addCell(new Cell().add(new Paragraph("RENTER MOBILE ").setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));
                table2.addCell(new Cell().add(new Paragraph("DRIVER STATE").setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));
                table2.addCell(new Cell().add(new Paragraph("RENT PER DAY").setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));

                //Table2-----02
                table2.addCell(new Cell().add(new Paragraph("1.")).setBackgroundColor(invoiceGray));              //STATIC 1,2,3...
                table2.addCell(new Cell().add(new Paragraph(carName)).setBackgroundColor(invoiceGray));            //car name
                table2.addCell(new Cell().add(new Paragraph(renterMobile)).setBackgroundColor(invoiceGray));                 //MOBILE RENTER
                table2.addCell(new Cell().add(new Paragraph(driver)).setBackgroundColor(invoiceGray));                        //DRIVER HOY TO
                table2.addCell(new Cell().add(new Paragraph(rpd)).setBackgroundColor(invoiceGray));                      //TOTAL PRICE
...
//        table2.addCell(new Cell().add(new Paragraph("12000")).setBackgroundColor(invoiceGray));
                ...
                table2.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table2.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
                table2.addCell(new Cell().add(new Paragraph("DEPOSIT ")).setFontColor(ColorConstants.WHITE).setBackgroundColor(ColorConstants.BLACK));
                table2.addCell(new Cell().add(new Paragraph(deposit).setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));      //DESPOSIT
                ...
                if (driver.equals("yes")) {
                    table2.addCell(new Cell().add(new Paragraph("GST (7%) + Driver Charges").setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));
                    double ta = Double.parseDouble(totalAmount);
                    double dp = ta - 10000f;
                    String dp1 = String.valueOf(dp);
                    table2.addCell(new Cell().add(new Paragraph(dp1).setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));         //GST

                } else {
                    table2.addCell(new Cell().add(new Paragraph("GST (7%)").setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));
                    double ta = Double.parseDouble(totalAmount);
                    double dp = ta - 10000f;
                    String dp1 = String.valueOf(dp);
                    table2.addCell(new Cell().add(new Paragraph(dp1).setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));         //GST
...
//                table2.addCell(new Cell().add(new Paragraph("")).setBorder(Border.NO_BORDER));
//
//                table2.addCell(new Cell().add(new Paragraph("Total Rent").setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));
//                double ta = Double.parseDouble(totalAmount);
////                double dp = ta - 10000f;
//                String dp1 = String.valueOf(totalAmount);
//                table2.addCell(new Cell().add(new Paragraph(dp1).setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));         //GST
                ...
                table2.addCell(new Cell().add(new Paragraph(totalAmount).setBold().setFontSize(16).setFontColor(ColorConstants.WHITE)).setBackgroundColor(ColorConstants.BLACK));                //TOTAL
                ...
                Drawable d3 = getDrawable(R.drawable.contactus1);
                ...
                table3.addCell(new Cell().add(new Paragraph("www.radhecarrenters.com\nYOUR_EMAIL@gmail.com")).setBorder(Border.NO_BORDER));     //USERNAME \nMOBILE \nEMAIL AAVE TO \nSURAT
                ...
                table3.addCell(new Cell().add(new Paragraph("Head office Address-Moon garden,Vip Circle,\nSurat,India")).setBorder(Border.NO_BORDER));
