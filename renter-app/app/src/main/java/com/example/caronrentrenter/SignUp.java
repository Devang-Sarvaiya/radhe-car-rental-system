...
public class SignUp extends AppCompatActivity {
    ...
    TextInputEditText txtname, txtmobile, txtemail, txtpass, txtconpass;
...
//    DatabaseReference reference_admin = database.getReference("Admin").child("Users");

    private DatabaseReference usersRef;
    RadioGroup radioGroup;
    String selectedOption, img = "", email_shared;
    Spinner spinner;
...
//                Toast.makeText(SignUp.this, value, Toast.LENGTH_SHORT).show();
    ...
    private void uploadUserDetails() {
        if (imageUri != null) {
            ...
            StorageReference imageReferenceProfile = storageReference.child("Users/profile/" + System.currentTimeMillis() + "." + getFileExtension(imageUri));
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    imageReferenceProfile.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            // Create HelperClass and upload to Firebase Realtime Database
                            ReadWriteUserDetails helperClass = new ReadWriteUserDetails(name, email, pass, mobile, "Surat", "", selectedOption, profileImageUrl, "false", "", "", "", "false");
...
//                            startActivity(intent);
    ...
    boolean valid() {
        ...
        if (TextUtils.isEmpty(txtName)) {
            ...
            return false;
        } else if (TextUtils.isEmpty(selectedOption)) {
            Toast.makeText(SignUp.this, "Please select your gender", Toast.LENGTH_SHORT).show();
            return false;
        } else if (img.isEmpty()) {

            Snackbar.make(txtemail, "Please select profile image", Snackbar.LENGTH_LONG).show();
