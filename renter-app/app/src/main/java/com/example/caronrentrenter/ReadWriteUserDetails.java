...
public class ReadWriteUserDetails implements Serializable {
    ...
    public ReadWriteUserDetails(String name, String email, String pass, String mobile, String city, String dll, String gender, String imageURLUser, String isVerified, String dlPic, String aadhar_front, String aadhaar_back, String admin_access_state) {
        this.name = name;
        this.email = email;
        this.pass = pass;
        this.mobile = mobile;
