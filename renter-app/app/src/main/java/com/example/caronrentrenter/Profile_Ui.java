...
public class Profile_Ui extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_profile_user = findViewById(R.id.showProfilePic);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Profile_Ui.this, MainFragment.class);
                startActivity(i);
            }
        });
...
historybtn.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
        startActivity(new Intent(Profile_Ui.this, bookingHistory.class));
    }
});
