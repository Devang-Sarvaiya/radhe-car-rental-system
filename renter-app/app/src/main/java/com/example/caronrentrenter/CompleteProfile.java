...
//    RadioButton male, female, other;
    ...
    DatabaseReference reference = database.getReference("Admin").child("Users");
    String emailShare, name, mob, pass, email, imageUrl, selectedOption, eem, img;
    RadioGroup radioGroup;
    RadioButton rdb_male, rdb_female, rdb_others;
    ScrollView onMainlayout;
    boolean val = false;
    boolean check;
    private ImageButton uploadUserDl, img_aadhaar_front, img_aadhaar_back;
...
//    private StorageReference storageReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_aadhaar_front = findViewById(R.id.img_aadhaar_front);
        img_aadhaar_back = findViewById(R.id.img_aadhaar_back);
...
//                                sendEmailVerification();
                    ...
                    if (val) {
                        ...
                        intent.putExtra("dri", selectedOption);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    imageReferenceDl.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uriDl) {
                            ...
                            if (imageUri2 != null) {
                                final StorageReference imageReferenceDl = storageReference.child("Admin").child("Users/aadhaar_front/" + System.currentTimeMillis() + "." + getFileExtension(imageUri2));
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        imageReferenceDl.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onSuccess(Uri uriDl) {
                                                ...
                                                if (imageUri3 != null) {
                                                    final StorageReference imageReferenceDl = storageReference.child("Admin").child("Users/aadhaar_back/" + System.currentTimeMillis() + "." + getFileExtension(imageUri3));
                                                        ...
                                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                            imageReferenceDl.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                ...
                                                                public void onSuccess(Uri uriDl) {
                                                                    ...
                                                                    // Create HelperClass and upload to Firebase
                                                                    ReadWriteUserDetails helperClass = new ReadWriteUserDetails(Name, Email, Pass, Mobile, "Surat", dll, Gender, profileImageUrl, isVerified.toString(), dlImageUrl, aadhaar_front, aadhaar_back, "false");
