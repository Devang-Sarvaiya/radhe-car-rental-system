...
public class Unverified_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MySwipeHelper swipeHelper = new MySwipeHelper(this,recyclerViewNew,400) {
            ...
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer) {
                buffer.add(new MyButton(Unverified_user.this,
                        "Delete",
                        50,
                        0,
                        ...
                        new MyButtonClickListener(){
                            ...
                            public void onClick(int pos) {
                                Toast.makeText(Unverified_user.this, "Delete click", Toast.LENGTH_SHORT).show();
                                deleteItem(pos);
...
//                        databaseReference_High1.child(dataSnapshot.getKey()).setValue(dataClass);
                ...
                adapter1 = new UserAdapter(Unverified_user.this, dataList1);
        ...
        databaseReference_High1.child(key).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Unverified_user.this, "User deleted successfully", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Unverified_user.this, "Failed to delete User", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
