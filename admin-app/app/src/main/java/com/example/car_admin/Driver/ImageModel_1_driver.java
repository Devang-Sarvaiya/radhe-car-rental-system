...
public class ImageModel_1_driver implements Serializable {
    public String name, email, mobile_dr, renter_mobile,aadhaar_card_number, gender, imageURLUser, isVerified, adharFrontImageUrl, adharBackImageUrl, insurance,dl,isCoonectedWithCar,isUnAvailable, driver_id,driver_pass,admin_access_state;
...
//    }
    ...
    public ImageModel_1_driver(String name, String email, String mobile, String admin, String dll, String gender, String profileImageUrl, String aTrue, String adharFrontImageUrl, String adharBackImageUrl, String insuranceImageUrl, String dlImageUrl, String aFalse, String s, String ID, String pass) {
    }

    public ImageModel_1_driver(String name, String email, String mobile_dr, String renter_mobile, String aadhaar_card_number, String gender, String imageURLUser, String isVerified, String adharFrontImageUrl, String adharBackImageUrl, String insurance, String dl, String isCoonectedWithCar, String isUnAvailable, String driver_id, String driver_pass, String admin_access_state) {
        this.name = name;
        this.email = email;
