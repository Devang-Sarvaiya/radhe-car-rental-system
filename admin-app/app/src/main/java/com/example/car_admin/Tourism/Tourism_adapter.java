...
public class Tourism_adapter extends RecyclerView.Adapter<Tourism_adapter.MyViewHolder>{
    ArrayList<TourClass> dataList;
    Context context;


    public Tourism_adapter(ArrayList<TourClass> dataList, Context context) {
