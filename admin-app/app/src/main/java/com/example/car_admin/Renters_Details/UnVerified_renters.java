...
public class UnVerified_renters extends AppCompatActivity {
...
//    private DatabaseReference usersRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_un_verified_renters);
        ...
        MySwipeHelper swipeHelper = new MySwipeHelper(this,recyclerViewNew,400) {
            ...
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer) {
                buffer.add(new MyButton(UnVerified_renters.this,
                        "Delete",
                        50,
                        0,
                        ...
                        new MyButtonClickListener(){
                            ...
                            public void onClick(int pos) {
                                Toast.makeText(UnVerified_renters.this, "Delete click", Toast.LENGTH_SHORT).show();
                                deleteItem(pos);
...
//                        databaseReference_High1.child(dataSnapshot.getKey()).setValue(dataClass);
                    ...
                    if(dataClass.isVerified.equals("false")){
                        dataList1.add(dataClass);
                    }

                }

                adapter1 = new RenterAdapter(UnVerified_renters.this, dataList1);
        ...
        databaseReference_High1.child(key).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(UnVerified_renters.this, "Renter deleted successfully", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UnVerified_renters.this, "Failed to delete renter", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
