...
import com.example.car_admin.UserDetails.Unverified_user;
import com.example.car_admin.UserDetails.Verified_user;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        add_car.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(requireActivity(), Verified_user.class);
        ...
        show_car.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(requireActivity(), Unverified_user.class);
                startActivity(intent);
            }
        });
...
//                }
//
//                adapter1 = new UserAdapter(getContext(), dataList1);
