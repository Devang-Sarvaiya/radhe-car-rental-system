...
public class All_cars1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_cars1);
        ...
        MySwipeHelper swipeHelper = new MySwipeHelper(this,recyclerViewPopular,400) {
            ...
            public void instantiateMyButton(RecyclerView.ViewHolder viewHolder, List<MyButton> buffer) {
                buffer.add(new MyButton(All_cars1.this,
                        "Delete",
                        50,
                        0,
                        ...
                        new MyButtonClickListener(){
                            ...
                            public void onClick(int pos) {
                                Toast.makeText(All_cars1.this, "Delete click", Toast.LENGTH_SHORT).show();
                                deleteItem(pos);
...
//                ArrayList<ImageModel1> dataList = new ArrayList<>();
                ...
                if (newItemCount > 0) {
                    Toast.makeText(All_cars1.this, newItemCount + " new item(s) added", Toast.LENGTH_SHORT).show();
                } else if (newItemCount < 0) {
                    Toast.makeText(All_cars1.this, "Some item(s) changed", Toast.LENGTH_SHORT).show();
                }
                ...
                if (adapter == null) {
                    adapter = new C_ItemAdapter(All_cars1.this, dataList);
            ...
            carRef.child(modelName).removeValue()
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(All_cars1.this, "Car deleted successfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(All_cars1.this, "Failed to delete Car", Toast.LENGTH_SHORT).show();
                        }
                    });
