...
public class UserAdapter extends RecyclerView.Adapter<RenterAdapter.ViewHolder>{
    ArrayList<DataClass> dataList;
    ArrayList<ReadWriteUserDetails1> dataList1;
...
//    }
    ...
    public UserAdapter(Context context1, ArrayList<ReadWriteUserDetails1> dataList1) {
        ...
        */
        ...
        holder1.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(holder1.itemView.getContext(), Approve_Deny_User.class);
...
//        return item.size();
    ...
    public ReadWriteUserDetails1 getItem(int position) {
