...
import com.example.car_admin.Tourism.Tourism_adapter;
...
public class Safety_feature_show extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saftey_feature_show);
...
//
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Admin").child("Saftey_feature");
