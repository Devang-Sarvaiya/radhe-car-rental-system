...
import com.example.car_admin.DriverEmail;
...
//                    Toast.makeText(add_driver.this, "Selected option: " + selectedOption, Toast.LENGTH_SHORT).show();
        ...
        img_dl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                e_mail = txtemail.getText().toString();

                sharedPreferences = getSharedPreferences("email_1", MODE_PRIVATE);
                SharedPreferences.Editor sedit = sharedPreferences.edit();
                sedit.putString("email", e_mail);
                sedit.commit();
                sedit.apply();
        ...
        btnregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valid()) {
                    ...
                    String mobi = txtmobile.getText().toString();
                    uploadUserDetails();
...
//                                                                                                            ImageModel_1_driver helperClass = new ImageModel_1_driver(Name, Email, Mobile, "Admin", Dll, Gender, profileImageUrl, "true", adharFrontImageUrl, adharBackImageUrl, insurance, dl, "false", "false", ID, pass);
////
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            if (imageUri1 != null) {
                                ...
                                imageReferenceAdharFront.putFile(imageUri1).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                            ...
                                            public void onSuccess(Uri uriAdharFront) {
                                                ...
                                                if (imageUri2 != null) {
                                                    ...
                                                    imageReferenceAdharBack.putFile(imageUri2).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                        ...
                                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                            imageReferenceAdharBack.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                ...
                                                                public void onSuccess(Uri uriAdharBack) {
                                                                    ...
                                                                    if (imageUri3 != null) {
                                                                        final StorageReference imageReferenceInsurance = storageReference.child("driver/insurance/" + System.currentTimeMillis() + "." + getFileExtension(imageUri3));

                                                                        imageReferenceInsurance.putFile(imageUri3).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                                            @Override
                                                                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                                imageReferenceInsurance.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                                    @Override
                                                                                    public void onSuccess(Uri uriInsurance) {
                                                                                        // Insurance image URL
                                                                                        String insuranceImageUrl = uriInsurance.toString();

                                                                                        // Upload Driving Licence image to Firebase
                                                                                        if (imageUri4 != null) {
                                                                                            final StorageReference imageReferenceDL = storageReference.child("driver/drivingLicence/" + System.currentTimeMillis() + "." + getFileExtension(imageUri4));

                                                                                            imageReferenceDL.putFile(imageUri4).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                                                                                @Override
                                                                                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                                                                    imageReferenceDL.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                                                        @Override
                                                                                                        public void onSuccess(Uri uriDL) {
                                                                                                            // Driving Licence image URL
                                                                                                            ...
                                                                                                            // Create HelperClass and upload to Firebase
                                                                                                            ImageModel_1_driver helperClass = new ImageModel_1_driver(name, email, mobile, "Admin", dll, gender, profileImageUrl, "true", adharFrontImageUrl, adharBackImageUrl, insuranceImageUrl, dlImageUrl, "false", "false", ID, pass);

                                                                                                            DatabaseReference reference_admin_general = FirebaseDatabase.getInstance().getReference("Admin").child("Drivers").child("General").child(mobile);
                                                                                                            reference_admin_general.setValue(helperClass);
                                                                                                            progressBar.setVisibility(View.GONE); // Hide progress bar on successful upload
                                                                                                            Toast.makeText(add_driver.this, "Driver added successfully!", Toast.LENGTH_SHORT).show();
                                                                                                            finish();
                                                                                                        }
                                                                                                    });
                                                        ...
                                                        public void onFailure(@NonNull Exception e) {
                                                            progressBar.setVisibility(View.GONE); // Hide progress bar on failure
                                                            Toast.makeText(add_driver.this, "Failed to upload Adhar Back image", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                                }
                                            }
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressBar.setVisibility(View.GONE); // Hide progress bar on failure
                                        Toast.makeText(add_driver.this, "Failed to upload Adhar Front image", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
...
//                    registeruser(txtName, txtMobile, txtEmail, txtPass, txtDll,City,txtGender);
    ...
    private void sendEmail() {
        new DriverEmail(add_driver.this) {
            @Override
            protected void onPostExecute(String[] result) {
                ...
                if (result != null && result.length == 2) {
                    ...
                    DatabaseReference reference_admin_general = FirebaseDatabase.getInstance().getReference("Admin").child("Drivers").child("General").child(Mobile);
                    reference_admin_general.child("driver_id").setValue(ID);
                    reference_admin_general.child("driver_pass").setValue(pass);
