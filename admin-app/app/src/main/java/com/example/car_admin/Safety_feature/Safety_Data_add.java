...
import com.example.car_admin.Tourism.TourClass;
...
public class Safety_Data_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saftey_data_add);
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Safety_Data_add.this, MainFragment.class));
            }
        });
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            Toast.makeText(Safety_Data_add.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
...
//    }
    ...
    private void uploadUserDetails() {
        ...
        if (imageUri != null) {
            final StorageReference imageReferenceProfile = storageReference.child("Safety_feature/Picture/" + System.currentTimeMillis() + "." + getFileExtension(imageUri));
            ...
            imageReferenceProfile.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    imageReferenceProfile.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            TourClass helperClass = new TourClass(placeName, placeDescription, placeLink, placeImageUrl);
                            DatabaseReference reference_admin = FirebaseDatabase.getInstance().getReference("Admin").child("Saftey_feature").child(placeName).child("Details");
                            reference_admin.setValue(helperClass).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    progressBar.setVisibility(View.GONE);
                                    Toast.makeText(Safety_Data_add.this, "Place added successfully!", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    progressBar.setVisibility(View.GONE);
                                    Toast.makeText(Safety_Data_add.this, "Failed to upload place details", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(Safety_Data_add.this, "Failed to upload place picture", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    boolean valid() {
        ...
        if (TextUtils.isEmpty(placeName)) {
            Toast.makeText(Safety_Data_add.this, "Please Enter Name", Toast.LENGTH_SHORT).show();
            modelName.setError("Name is required");
            modelName.requestFocus();
            check = false;
        } else if (TextUtils.isEmpty(placeDescription)) {
            Toast.makeText(Safety_Data_add.this, "Please Enter Description", Toast.LENGTH_SHORT).show();
            modelDescription.setError("Description is required");
            modelDescription.requestFocus();
            check = false;
        } else if (TextUtils.isEmpty(placeLink)) {
            Toast.makeText(Safety_Data_add.this, "Please Enter Link", Toast.LENGTH_SHORT).show();
