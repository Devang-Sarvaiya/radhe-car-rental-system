...
public class Date_Book extends AppCompatActivity {
    ...
    final private DatabaseReference databaseReference_Date = FirebaseDatabase.getInstance().getReference("date");
...
//                databaseReference_admin.child("Payment").child(rMO).child("Car").child(mType).child("Company").child(mCom).child(modelname).child("Details").child("rentersMobile").setValue("false");
                ...
                Intent i=new Intent(Date_Book.this, Main_Payment.class);
