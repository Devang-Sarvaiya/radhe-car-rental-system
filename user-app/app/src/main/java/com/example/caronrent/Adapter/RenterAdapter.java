...
import com.example.caronrent.ReadWriteUserDetails2;
...
public class RenterAdapter extends RecyclerView.Adapter<RenterAdapter.ViewHolder> {
    ...
    ArrayList<ReadWriteUserDetails2> dataList1;
...
//    }
    ...
    public RenterAdapter(Context context1, ArrayList<ReadWriteUserDetails2> dataList1) {
        ...
        */
        ...
        holder1.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(holder1.itemView.getContext(), Call.Details.class);
