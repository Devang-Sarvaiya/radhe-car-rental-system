...
import com.example.caronrent.E_commerce.ImageModel_1_e_com;
...
public class D_ItemAdapter extends RecyclerView.Adapter<D_ItemAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.model.setText(dataList.get(position).getCarName());
...
//        });
    ...
    public void searchdatalist(ArrayList<ImageModel_1_driver> searchList){
        dataList=searchList;
        notifyDataSetChanged();
    }

    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView title, address, price,model;
        ImageView pic;
