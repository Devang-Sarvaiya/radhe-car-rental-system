...
public class DataClass implements Serializable {
    ...
    private String isDriverConnectedWithCar;
    private String isRideCancel;
    private String isDriverConnected;
    private String DriverMobile;
    private List<String> imageUrls; // Add this lin
    ...
    public DataClass(String modelName, String modelDescription, String imageURL, String rcBookImageURL, String insuranceImageURL, String chassisNumberImageURL, String rentPerDay, String maximumSpeed, String fuel, String numberPassengers, String gearMode, String carCompany, String carType, String pickUpPoint, String renterMobile, int productCounter, String isVerified, String isBooked, String isUnavailable, String start_date, String end_date, String fuelType, String doors, String isDriverConnectedWithCar, String isRideCancel, String isDriverConnected, String driverMobile, List<String> imageUrls) {
        ...
        this.doors = doors;
        this.isDriverConnectedWithCar = isDriverConnectedWithCar;
        this.isRideCancel = isRideCancel;
        this.isDriverConnected = isDriverConnected;
    ...
    public String getIsDriverConnectedWithCar() {
        return isDriverConnectedWithCar;
    }

    public void setIsDriverConnectedWithCar(String isDriverConnectedWithCar) {
        this.isDriverConnectedWithCar = isDriverConnectedWithCar;
    }

    public String getIsRideCancel() {
        return isRideCancel;
    }

    public void setIsRideCancel(String isRideCancel) {
        this.isRideCancel = isRideCancel;
    }

    public String getIsDriverConnected() {
        return isDriverConnected;
    }

    public void setIsDriverConnected(String isDriverConnected) {
        this.isDriverConnected = isDriverConnected;
    }
